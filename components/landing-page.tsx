    ...
    items: [
      {
        label: "Top",
        name: "Striped Shirt",
        img: "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=200&h=267&fit=crop&q=80",
      },
      {
        label: "Bottom",
        name: "Wide Jeans",
        img: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=200&h=267&fit=crop&q=80",
      },
      {
        label: "Shoes",
        name: "White Sneakers",
        img: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=200&h=267&fit=crop&q=80",
      },
    ],
    ...
    items: [
      {
        ...
        img: "https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=200&h=267&fit=crop&q=80",
      },
      {
        label: "Bottom",
        name: "Slim Trousers",
        img: "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=200&h=267&fit=crop&q=80",
      },
      {
        label: "Shoes",
        name: "Chelsea Boots",
        img: "https://images.unsplash.com/photo-1608256246200-53e635b5b65f?w=200&h=267&fit=crop&q=80",
      },
    ],
    ...
    items: [
      {
        label: "Top",
        name: "Vintage Tee",
        img: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=200&h=267&fit=crop&q=80",
      },
      {
        label: "Bottom",
        name: "Cargo Shorts",
        img: "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=200&h=267&fit=crop&q=80",
      },
      {
        label: "Shoes",
        name: "Loafers",
        img: "https://images.unsplash.com/photo-1531310197839-ccf54634509e?w=200&h=267&fit=crop&q=80",
      },
    ],
...
export function LandingPage() {
  ...
  useEffect(() => {
    ...
    container
      .querySelectorAll<HTMLElement>(".lp-reveal, .lp-word-reveal")
  ...
  useEffect(() => {
    const container = containerRef.current;
    if (!container || !prefersInteractiveMotion()) return;
    const handlers = Array.from(container.querySelectorAll<HTMLElement>(".lp-feature-card")).map(
      (fc) => {
    ...
    <div className="lp" ref={containerRef}>
      ...
      {isMobileMenuOpen && (
        <div className="lp-mobile-menu">
          ...
          <a href="#how" className="lp-mobile-menu-link" onClick={() => setIsMobileMenuOpen(false)}>
            How it works
          </a>
          <a
            href="#features"
          ...
          <div className="lp-mobile-cta-group">
            <Link
              href="/sign-in"
              className="lp-mobile-btn-signin"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Open wardrobe
            </Link>
      ...
      <section className="lp-hero">
        ...
        <div className="lp-hero-left" style={{ position: "relative", zIndex: 2 }}>
          ...
          <h1 className="lp-hero-headline">
            ...
            <br />
            <span className="lp-word-reveal">
              <span style={{ transitionDelay: "0.25s" }}>
                <em>already&nbsp;own.</em>
              </span>
            </span>
          </h1>
          <p className="lp-hero-sub lp-reveal lp-reveal-delay-2">
            driply turns your closet into daily ready-fits — tuned to the weather, your vibe, and
            colors that actually match.
          </p>
            ...
            <div className="lp-outfit-card" ref={cardRef}>
              ...
              <div className="lp-outfit-tags">
                {outfit.tags.map((tag, i) => (
                  <span
                    key={tag}
                    className={`lp-tag${i === outfit.tagAccent ? " lp-tag-accent" : ""}`}
                  >
                    {tag}
                  </span>
                ))}
        ...
        <div className="lp-steps-grid">
          <div className="lp-step lp-reveal lp-reveal-delay-1">
            ...
            <p className="lp-step-desc">
              Photograph your clothes once. driply reads colors, fabric types, and garment
          ...
          <div className="lp-step lp-reveal lp-reveal-delay-2">
            ...
            <p className="lp-step-desc">
              Every morning, driply checks your local weather and surfaces three ready-to-wear
              combinations from your actual closet.
            </p>
          </div>
          <div className="lp-step lp-reveal lp-reveal-delay-3">
            ...
            <p className="lp-step-desc">
              Rate outfits to train your taste profile. driply gets sharper with every tap — no two
              closets look the same.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="lp-features-section" id="features">
        <div className="lp-features-inner">
          <div className="lp-features-header">
            ...
            <p className="lp-section-sub lp-reveal lp-reveal-delay-2">
              Most fashion apps want you to buy more. driply is designed to help you shop less — and
          ...
          <div className="lp-features-grid">
            <div className="lp-feature-card lp-reveal">
              ...
              <p className="lp-feature-desc">
                Analyzes complementary and analogous color relationships across your wardrobe so
                every fit coheres.
              </p>
            </div>
            <div className="lp-feature-card lp-reveal lp-reveal-delay-1">
              ...
              <p className="lp-feature-desc">
                Fabric weight and breathability are factored into suggestions. No more dressing
                wrong for the day.
              </p>
            </div>
            <div className="lp-feature-card lp-reveal lp-reveal-delay-2">
              ...
              <p className="lp-feature-desc">
                Your wardrobe data never leaves your device in identifiable form. No selling your
                style to brands.
              </p>
            </div>
            <div className="lp-feature-card lp-reveal lp-reveal-delay-3">
              ...
              <p className="lp-feature-desc">
                Tag moods — chill, formal, streetwear, vintage — and filter fits by the energy of
                your day.
              </p>
            </div>
          </div>
